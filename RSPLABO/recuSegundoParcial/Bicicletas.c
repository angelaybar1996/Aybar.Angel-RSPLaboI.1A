...
int biciCmpId(void* a, void* b)
{
    ...
    if(a!=NULL && b!=NULL)
    {
        ...
        if(bici1->id > bici2->id)
        {
            retorno=1;
        }
        else if(bici1->id < bici2->id)
        {
            retorno=-1;
        }
    }
...
/** \brief Determina el orden del tiempo
 *
 * \param a void* puntero a castear para que sea puntero eBicicleta
 * \param b void* puntero a castear para que sea puntero eBicicleta
 * \return retorna 0 si son iguales,1 si a>b y -1 si a<b
 ...
 */
 /*
int biciCmpTiempo(void* a, void* b)
{
    int retorno=0;
    eBicicleta* bici1;
    eBicicleta* bici2;
